...
Line::Line(Shader * pShader, const std::vector<Vertex> & vertices, const glm::mat4 & model)
        : GLShape(pShader, model), vertices(vertices)
{
...
void Line::render(float timeElapsedSinceLastFrame)
{
    pShader->use();
